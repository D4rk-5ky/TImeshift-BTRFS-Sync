...
def _refresh_state_metadata_from_timeshift(config, state: dict, *, dry_run: bool) -> list[str]:
    ...
    snapshots = list_source_snapshots(config, ssh, include_btrfs_info=False)
